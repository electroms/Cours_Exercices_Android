...
public class MainActivity extends AppCompatActivity {
    ...
    // Variables pour récupérer les éléments de la vue
    private Button btnTrue;
    private Button btnFalse;
    private TextView tvQuestion;
    private TextView tvScore;

    // pour stocker la liste de questions
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        // récupères les données enregistré dans savedInstanceState lors
        // de l'appel à la méthde onSaveInstanceState
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.cheat:
                // on crée un Bundle pour stocker l'objet question
                Bundle bundle = new Bundle();
                bundle.putSerializable(KEY_QUESTION, question);

                // appel et démarre l'activity CheatActivity avec un intent
                Intent intent = new Intent(getApplicationContext(), CheatActivity.class);
                // ajoute le bundle dans l'intent
